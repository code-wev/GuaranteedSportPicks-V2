import { ArrowUpRight, ChevronDown, ShoppingCart, UserCircle2 } from 'lucide-react';
  ...
  return (
    <header className='w-full bg-black border-b border-[rgba(255,255,255,0.1)]'>
      <div className='w-full max-w-[1920px] mx-auto px-4 xl:px-[200px] py-[15px] flex items-center justify-between'>
        ...
        <Link
          href='/'
          className='relative shrink-0 w-[117px] h-[54px] flex items-center justify-center'
        >
          <Image src='/GSPLOGO.png' alt='GSP Logo' fill className='object-contain' priority />
        </Link>
        ...
        <nav className='hidden lg:flex items-center gap-[20px]'>
          <div className='flex flex-col items-center justify-center'>
            <Link
              href='/'
              className='font-sans text-[18px] font-normal leading-[28px] text-white whitespace-nowrap'
            >
              Home
            </Link>
          ...
          <Link
            href='/how-it-works'
            className='font-sans text-[18px] font-normal leading-[28px] text-white whitespace-nowrap opacity-80 hover:opacity-100 transition-opacity'
          >
            How It Works
          </Link>
          <Link
